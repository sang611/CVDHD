    ...
    <div class="courses-body container-courses">
        <div class="courses-header">
            <div class="courses-title">
                <h1>Vue.js & JavaScript Courses</h1><br>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A animi architecto et explicabo fuga hic, odio rem repellendus soluta unde?</p>
            </div>
        ...
        <div class="courses-filter">
            ...
            <div id="filters-dropdown">
                <div class="dropdown">
                    <button class="dropdown-toggle" type="button" data-toggle="dropdown">Skill level
                ...
                <div class="dropdown">
                    <button class="dropdown-toggle" type="button" data-toggle="dropdown">Watched state
                        <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li><a href="#">All</a></li>
        ...
        <div class="courses-list">
            ...
            <div class="course-item">
                <div class="course-item-img">
                    <div style="background-image: url('https://vueschool.io/media/13867ba07d6eacdf868c78a340784a52/scoped-slots-course-not-transparent.jpg');"></div>
                </div>
                <div class="course-item-desc">
                    <h3 class="course-title">Vue 3 Composition API</h3><br>
                    <p class="course-subtitle">
            ...
            <div class="course-item">
                <div class="course-item-img">
                    <div style="background-image: url('https://vueschool.io/media/0e0ebe693c234f487c1eccc5cad3faaa/modern-javascript-es6-and-beyond.jpeg');"></div>
                </div>
                <div class="course-item-desc">
                    <h3 class="course-title">Vue 3 Composition API</h3><br>
                    <p class="course-subtitle">
